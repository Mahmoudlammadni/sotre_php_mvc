...
<head>
  ...
  <title>Create Account | LuxeCart</title>
  ...
  <style>
    ...
    .input-icon-wrap .input-icon { position: absolute; left: 14px; top: 50%; transform: translateY(-50%); color: var(--text-muted); width: 18px; height: 18px; pointer-events: none; }
    .input-icon-wrap .form-input { padding-left: 44px; }
    .name-row { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }
    .auth-check { display: flex; align-items: flex-start; gap: 10px; margin-bottom: 24px; font-size: 13px; color: var(--text-muted); line-height: 1.5; }
    .auth-check input[type="checkbox"] { width: 16px; height: 16px; accent-color: var(--primary); margin-top: 2px; flex-shrink: 0; }
    ...
    .social-auth button { flex: 1; display: flex; align-items: center; justify-content: center; gap: 8px; padding: 10px; border: 1px solid var(--border); border-radius: var(--radius-md); background: var(--surface); cursor: pointer; font-size: 13px; font-weight: 500; color: var(--text); transition: background var(--transition), border-color var(--transition); }
...
<div class="auth-page">
  <div class="card auth-card">
    <div class="auth-header">
      ...
      <p>Join 50,000+ happy shoppers</p>
    ...
    <form action="index.php?controller=client&action=StoreClient" method="post">
      ...
      <div class="form-group">
        ...
        <div class="input-icon-wrap">
          ...
          <input class="form-input" type="text" name="name" required placeholder="John Doe">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="input-icon-wrap">
          ...
          <input class="form-input" type="password" name="password" id="regPassword" required placeholder="Create a strong password" minlength="6">
        ...
        <p style="font-size:12px;color:var(--text-muted);margin-top:4px;">At least 6 characters</p>
      </div>
      ...
      <div class="name-row">
        <div class="form-group">
          ...
          <div class="input-icon-wrap">
            ...
            <input class="form-input" type="text" name="phone" placeholder="+1 (555) 000-0000">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="input-icon-wrap">
            ...
            <input class="form-input" type="text" name="address" placeholder="123 Main St, City">
          </div>
        </div>
      </div>
      ...
      <div class="auth-check">
        ...
        <label for="terms">I agree to the <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a>. By creating an account, I agree to receive marketing emails (can unsubscribe anytime).</label>
      </div>
    ...
    <p class="auth-footer">
      Already have an account? <a href="index.php?controller=user&action=showLogin">Sign In</a>
    </p>
  </div>
</div>
